...
var helpByCtx = map[string]struct {
	...
	"detail": {"PR詳細", []helpLine{
		{"Tab / Shift-Tab / 1-5", "タブ切替 (Overview/Outline/Files/Comments/Memo)"},
		{"l / h  (→/←)", "タブ切替 (次 / 前)"},
		{"j / k / ↑ / ↓", "移動 (Outline/Comments: 左リスト移動、右にプレビュー)"},
		{"Enter", "Outline: 展開/diffへ / Files: diffツール / Comments・Memo: コードへ"},
		...
		{"m / M", "PR全体メモを追加 / Memoタブへ (メモはローカル保存、投稿されない)"},
